 ...
 * @author ogun.ark
 */
public class suppCrsEns extends javax.swing.JPanel {
    ...
    private void btokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btokActionPerformed
        ...
        if (!erreur) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Êtes-vous sûr de vouloir supprimer tous les cours associé à un enseignant ?", "Warning", dialogButton);
            if (dialogResult == JOptionPane.YES_OPTION) {
                String msg = m.suppCoursEns(cours);
